...
const notificaitonRoutes = require("./app/routes/notifications")(app, jwt);
const galleryRoutes = require("./app/routes/gallery")(app, jwt);
const feeRoutes = require("./app/routes/fee")(app, jwt);


app.use("/auth", authenticationRoutes);
app.use("/notification", notificaitonRoutes);
app.use("/gallery", galleryRoutes);
app.use("/feestructure", feeRoutes);
